...
import "./termos-condicoes-comprador.scss"
const TermosCondicoesComprador = () => {
							...
							<div className="container-header">
								<div className="row">
									<div className="col-12 d-flex align-items-center justify-content-between">
										...
										<h3 className='xl'>Termos e condições do comprador</h3>
...
export default TermosCondicoesComprador;